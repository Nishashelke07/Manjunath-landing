...
export default function WhyChooseHealthyNation_Unique() {
  ...
  return (
    <section className="bg-white">
      {/* tiny local CSS for smooth content swap */}
      <style>{`
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="relative overflow-hidden rounded-[34px] bg-[#FAF3EE] px-6 sm:px-10 py-10 sm:py-14">
          {/* background accents (no extra text) */}
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute right-6 top-6 text-neutral-900/55">
              <svg viewBox="0 0 48 48" className="w-10 h-10" aria-hidden="true">
                {Array.from({ length: 12 }).map((_, i) => {
                  const a = (i * Math.PI) / 6;
                  const x1 = 24 + Math.cos(a) * 6;
                  const y1 = 24 + Math.sin(a) * 6;
          ...
          <div className="relative mt-10 grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:items-center">
            {/* LEFT: vertical navigator (no boxes) */}
            ...
            {/* RIGHT: folded “paper sheet” that changes (single shape, not a box/card grid) */}
            <div className="relative">
              {/* outer glow edge */}
